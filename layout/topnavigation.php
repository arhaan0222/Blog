...
<link rel="stylesheet" type="text/css" href="http://localhost/Blog-master/blog-template/vendor/bootstrap/css/bootstrap.css">
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      <a class="navbar-brand" href="http://localhost/Blog-master/">Technoria</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <?php 
             ...
             ?>
          <li class="nav-item">
            <a class="nav-link" href="http://localhost/Blog-master/category/<?= $view_category_id; ?>"><?php echo $view_cat_title; ?></a>
          </li>
          <?php  
                }
                }
